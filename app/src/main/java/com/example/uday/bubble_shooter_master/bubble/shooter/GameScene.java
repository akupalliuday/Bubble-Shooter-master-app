...
import com.example.uday.bubble_shooter_master.game.engine.Layer;
import com.example.uday.bubble_shooter_master.game.engine.Scene;
...
import com.example.uday.bubble_shooter_master.game.engine.TextSprite;
...
//		System.out.println("LevelSelectMenu.selected = " + LevelSelectMenu.selected);
		...
		// period bet. downs
		downPeriod = 600 - com.example.uday.bubble_shooter_master.bubble.shooter.LevelSelectMenu.selected*50 ;
...
//	    Load the Array
		array = BubbleShootActivity.generator.load( com.example.uday.bubble_shooter_master.bubble.shooter.LevelSelectMenu.levelSelected) ;
//		Calculate ShiftUp	
...
//	    b = getRandomBubble();
	   ...
	   ts = new TextSprite(null, "LEVEL :"+ com.example.uday.bubble_shooter_master.bubble.shooter.LevelSelectMenu.levelSelected+"         SCORE: "+score, 0, 10,Color.GREEN);
	   clayer.addSprite(ts);
//	   layer.addSprite(ts);
	}
...
//	Handle Win/Lose Action
	public void winlose(boolean win){
		...
		if(win){
			 ...
			 if (com.example.uday.bubble_shooter_master.bubble.shooter.Options.soundBoolean)
...
//							BubbleShootActivity.fallPlayer.start();
						...
						if (com.example.uday.bubble_shooter_master.bubble.shooter.Options.vibrateBoolean)
						...
						while (!BubblesGroup.isEmpty())
							...
							// Update Score
							ts.text ="Level :"+ com.example.uday.bubble_shooter_master.bubble.shooter.LevelSelectMenu.levelSelected+"           Score = "+score;
					}
	...
	public static void getRandomBubble(){
		...
		if (pool.size()>0)
			b =pool.remove(0).reIntialize((int) (originalPoint.x+((bubbleSize*1.5)*bubbles.size())),originalPoint.y,
                    com.example.uday.bubble_shooter_master.bubble.shooter.Generate.rand.nextInt(5));
		else
